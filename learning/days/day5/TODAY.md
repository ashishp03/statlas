...
### Step 1 — Watch (~27 min)
- [ ] **3Blue1Brown — "Attention in transformers, visually explained"** (Ch. 6 of the NN series).
...
### Step 2 — Read (~40 min)
- [ ] **Jay Alammar — "The Illustrated Transformer."** Read slowly, all the way through the
      self-attention + multi-head sections. https://jalammar.github.io/illustrated-transformer/

### Step 3 — Read the source (~30 min)
- [ ] **"Attention Is All You Need," §3.1–3.2** (the attention + multi-head math), with the
...
- [ ] Open **`learning/days/day5/exercises/attention_from_scratch.ipynb`** in VS Code.
- [ ] Complete the 3 TODOs: `softmax`, `scaled_dot_product_attention`, `causal_mask`.
- [ ] Run every cell — keep fixing until **all the ✅ test cells pass.**

### Step 5 — Log it
- [ ] Tell the coach (this chat) what you finished, e.g. "did steps 1–4, all tests pass." I'll
